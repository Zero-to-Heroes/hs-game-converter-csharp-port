...
namespace HearthstoneReplays.Events.Parsers
{
    public class CardBuffedInHandParser : ActionParser
    {
        ...
        private List<string> validBuffers = new List<string>()
        {
            ...
            CardIds.GrimestreetOutfitter_CORE_CFM_753,
            CardIds.GrimestreetOutfitter_CFM_753,
        ...
        private Dictionary<string, string> buffs = new Dictionary<string, string>()
        {
            ...
            { CardIds.GrimestreetOutfitter_CORE_CFM_753, CardIds.GrimestreetOutfitter_SmugglingEnchantment},
            { CardIds.GrimestreetOutfitter_CFM_753, CardIds.GrimestreetOutfitter_SmugglingEnchantment},
            ...
            { CardIds.CheatDeath_CORE_LOOT_204, CardIds.CheatDeath_CloseCallEnchantment},
            { CardIds.CheatDeath_LOOT_204, CardIds.CheatDeath_CloseCallEnchantment},
